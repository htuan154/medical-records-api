...
<head>
    <meta charset="UTF-8">
    <title>{{ config('l5-swagger.documentations.'.($documentation ?? 'default').'.api.title') }}</title>
    <!-- Use CDN for Swagger UI assets to avoid proxy/asset path issues in production -->
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.27.1/swagger-ui.css">
...
<script src="https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.27.1/swagger-ui-bundle.js"></script>
...
<script>
    window.onload = function() {
        ...
        const ui = SwaggerUIBundle({
            ...
            oauth2RedirectUrl: "{{ route('l5-swagger.'.($documentation ?? 'default').'.oauth2_callback', [], $useAbsolutePath) }}",
