          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <div class="input-icon-wrap">
                ...
                <input type="text" class="vue__time-picker" value="12:00" readonly />
              </div>
            </div>
            <div class="col-md-3">
              ...
              <div class="input-icon-wrap">
                ...
                <input type="text" class="vue__time-picker" value="13:00" readonly />
              </div>
            </div>
          </div>
  ...
  methods: {
    ...
    emptyForm () {
      return {
        ...
        // schedule
        working_days: [],
        working_start: '08:00', // Giá trị mặc định có thể chỉnh sửa
        working_end: '17:00', // Giá trị mặc định có thể chỉnh sửa
    ...
    openCreate () {
      ...
      // Gán giờ nghỉ trưa mặc định 12:00-13:00
    ...
    openEdit (row) {
      ...
      this.form = {
        ...
        working_start: sch.working_hours?.start || '08:00', // Giá trị mặc định nếu không có
        working_end: sch.working_hours?.end || '17:00', // Giá trị mặc định nếu không có
