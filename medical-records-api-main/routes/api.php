...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('log.request')->group(function () {
        ...
        // 🔍 PUBLIC routes for debugging - ALL MODULES
        Route::get('/appointments-public', [AppointmentController::class, 'index']);
        Route::get('/medical-tests-public', [MedicalTestController::class, 'index']);
        Route::get('/patients-public', [PatientController::class, 'index']);
        Route::get('/doctors-public', [DoctorController::class, 'index']);
        Route::get('/medical-records-public', [MedicalRecordController::class, 'index']);
        Route::get('/treatments-public', [TreatmentController::class, 'index']);
        Route::get('/medications-public', [MedicationController::class, 'index']);
